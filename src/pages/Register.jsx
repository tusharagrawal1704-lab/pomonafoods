...
import GoogleIcon from "@/components/Googlecon";
...
export default function Register() {
  ...
  const handleGoogle = () => auth.loginWithProvider("google");
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          ...
          <Input id="fullname" type="text" placeholder="John Doe" value={fullName} onChange={e => setFullName(e.target.value)} className="h-12" />
        </div>
        <div className="space-y-2">
